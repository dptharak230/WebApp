...
<html>
<head>
<title> Marslander Communication Website</title>
<style>
body{
...
<a href="" style="color: white;font-size: 20px;position: absolute;left:69px;">All Queries</a><br>
<a href="" style="color: white;font-size: 20px;position: absolute;left:56px;">Post a Query</a><br>
</section>
<div>
</div>
